...
<head>
    ...
    <meta name="Description" content="UK University Consultant"/>
    <meta name="keywords" content="team, consultancy, a, bridge, to, uk, universities, study uk, low ielts, abroad">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Virtual Counselling with University of Chester</title>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent"
                                                                ...
                                                                <a class="mcnButton "
                                                                   title="Click for Facebook Live Session"
                                                                   href="https://www.facebook.com/events/457371321769899/"
                                                                   target="_blank"
                                                                   style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Click
                                                                    for Facebook Live Session</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <em>Copyright © 2016-2020, All rights reserved.</em><br>
                                                                <br>
                                                                <strong>Our mailing address is:</strong><br>
                                                                admission@teamconsultancy.co.uk
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
